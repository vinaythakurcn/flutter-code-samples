...
const double _kTrackRadius = 5.0;
const double _kThumbRadius = 12.0;
const double _kSwitchWidth = _kTrackWidth - 2 * _kTrackRadius + 2 * 20.0;
const double _kSwitchHeight = 2 * 20.0 + 8.0;
const double _kSwitchHeightCollapsed = 2 * 20.0;
